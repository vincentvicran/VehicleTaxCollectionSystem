...
import 'package:vehicle_tax_collection_system/Vehicle_Registration/vehicle.dart';
          ...
          child: ListView(
            children: [
              ...
              Padding(
                ...
                child: fields('Owner Name', ownerName, emptyValidator, null,
              ...
              Padding(
                ...
                child: fields(
                    ...
                    vehicleNumber,
                    emptyValidator,
                    'Eg. BA 10 PA 1010 / BAGMATI PRADESH 3 2 003 PA 1111',
                  ...
                  InkWell(
                    onTap: () {
                      if (formkey.currentState.validate()) {
                        var newVehicle = AddVehicleModel(ownerName: ownerName.text,
                            vehicleNumber: vehicleNumber.text,
                            vehicleregistrationDate: vehicleRegitrationDate.text,
                            engineCapacity: engineCapacity.text,
                            latestpaymentDate: latestPaymentDate.text
                            );


                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Vehicle(vehicle: newVehicle)),
                        );
                      } else {
                        print("Not Validated");
                      }
